...
public class seleccionarReservacion extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("SELECCIONAR RESERVACION:");
    ...
    private void mostrarParadas(List listaReservaciones) {
        try {
            if (listaReservaciones != null) {
                ...
                panelInterno.setPreferredSize(new Dimension(740, listaReservaciones.size() * 50));
                panelInterno.setBackground(Color.WHITE);
                for (Object reservacion : listaReservaciones) {
